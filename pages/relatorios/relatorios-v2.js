/**
 * Sistema completo de relatórios Sun Motors Dashboard
 * Arquivo único com toda a lógica para melhor performance
...
// ===============================================
// CLASSE PRINCIPAL - RelatoriosData
// ===============================================
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 Inicializando página de relatórios...');
    console.log('📁 Versão consolidada: HTML, CSS e JS únicos para melhor performance');
    
    // Aguardar Supabase estar disponível
    setTimeout(() => {
        if (window.relatoriosData) {
            console.log('✅ RelatoriosData disponível - inicializando...');
            window.relatoriosData.inicializarPagina();
        } else {
            console.error('❌ RelatoriosData não disponível');
            console.log('🔍 Tentando novamente em 1 segundo...');
            
            // Tentativa adicional após 1 segundo
            setTimeout(() => {
                if (window.relatoriosData) {
                    console.log('✅ RelatoriosData carregado na segunda tentativa');
                    window.relatoriosData.inicializarPagina();
                } else {
                    console.error('❌ RelatoriosData ainda não disponível após segunda tentativa');
                }
            }, 1000);
        }
    }, 500);
